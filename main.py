...
def main():
    ...
    # fileio.print_data(fileio.process_file_CSV('531 4-day program - TM Log.csv'))

    # * Generates graphs from data provided to generate_graph function in graph.py
    graph.generate_graph("Bench Press",fileio.process_file_CSV('531 4-day program - TM Log.csv'))
